...
const Profile = () => {
  ...
  const balance = transactions?.reduce((total, t) => {
    ...
    if (t.type === "withdraw" || t.type === "transfer") return total - t.amount;
    return total;
  }, 0) || 0;
      ...
      <View style={styles.container}>
        <View style={styles.profileSection}>
          ...
          <View style={styles.usernameContainer}>
            ...
            <Text style={[styles.usernameLabel, { marginTop: 16 }]}>Balance</Text>
            <Text style={styles.username}>{balance.toFixed(2)} {currency}</Text>
          </View>
